...
export const ENEMY_TYPES: EnemyType[] = [
  ...
  },
  {
    ...
    combatMechanics: falseSacrariumMechanics,
    deathHint:
    ...
    movement: "Stationary, spreads corruption",
    seesInDark: false,
    reactsToLight: "Ignores",
    corporeal: true,
    onClosedDoors: "Blocked",
